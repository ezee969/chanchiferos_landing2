...
const Features = () => {
  ...
  return (
    //background from red to blue gradient
    <section className="py-52 px-72 items-center bg-gradient-to-b from-neutral-background to-neutral-secundary flex flex-col gap-14 dark:bg-slate-800">
