    ...
    <div className="grid gap-9 text-lg dark:text-neutral-100">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex gap-3 items-center">
          ...
          <Stars />
          <p className="ml-4   text-positive-button  cursor-pointer">
      ...
      <SizeFilter />
      {/*  */}
      <button className="w-full bg-positive-button rounded py-2 hover:bg-positive-button-darker active:bg-positive-button-active transition-all text-white">
      ...
      {/*  */}
      <button className="w-full text-positive-button rounded py-2 hover:bg-neutral-secondary active:bg-amber-100 transition-all border border-positive-button">
