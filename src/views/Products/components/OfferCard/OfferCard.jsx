...
const OfferCard = () => {
  return (
    <div className="animate-fadeIn  flex items-center justify-around border-2 rounded-lg border-green-primary p-2  w-full">
      <div className="w-40">
      ...
      <button className="rounded-lg cursor-pointer py-3 px-9 bg-positive-button  text-white hover:bg-positive-button-darker active:bg-positive-button-active transition-all">
