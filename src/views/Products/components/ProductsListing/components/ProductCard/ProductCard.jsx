...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className=" flex flex-col  ">
      <div className=" w-72 p-3 mb-3 bg-neutral-secondary">
        <div
      ...
      <div className="w-full flex gap-2 mt-5 mb-2">
        <button className="w-1/2 bg-positive-button rounded py-2 hover:bg-positive-button-darker active:bg-positive-button-active transition-all">
