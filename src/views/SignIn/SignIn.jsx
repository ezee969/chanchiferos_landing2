    ...
    >
      <div className="bg-gray-100 dark:bg-slate-700 text-gray-500 rounded-3xl shadow-xl w-[65%] overflow-hidden animate-fadeIn">
        <div className="md:flex w-full m-3 ">
          <div className="hidden md:block w-1/2 rounded-l-xl bg-neutral-secondary py-10 px-10">
            <svg
                ...
                <div className="w-full px-3 mb-5">
                  <div>
                    ...
                    <label className="inline-flex items-center cursor-pointer">
                      ...
                      />
                      <span className="ml-2 text-sm font-semibold text-slate-900 dark:text-neutral-50">
